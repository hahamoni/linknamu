...
|---|---|---|---|---|---|---|---|---|
| **P01** | 헤디 라마르 · US2292387 | 42.5s | 정체 공개 — 할리우드의 전설 | ✅ | ✅ | ✅ | ✅ 한 / ⏳ 영 | ✅ **한국어 완성** |
| **P02** | 리지 매기 · US748626 | 43.3s | 목적 반전 — 독점을 가르치려던 게임 | ✅ | ✅ | ✅ | ⏳ | 프리뷰만 |
| **P03** | 위저 보드 · US446054 | 44.2s | 이름의 출처 — 그녀 목걸이 속 'Ouida' | ✅ | ◐ | ⏳ | ⏳ | — |
| **P04** | 니콜스 큐브 · US3655201 | 41.8s | 단어 하나 '여덟'이 판을 뒤집음 | ✅ | ◐ | ⏳ | ⏳ | — |
| **P05** | 링컨 · US6469 | 40.9s | 정체 공개 — 특허를 가진 유일한 대통령 | ✅ | ✅ | ✅ | ⏳ | 프리뷰만 |
| **P06** | 휴지 방향 · US465588 | 36.9s | 통설 자체를 뒤집음 — 방향을 없애려던 발명 | ✅ | ✅ | ✅ | ⏳ | 프리뷰만 |
| **P07** | 지퍼 · US504038 | 40.0s | 이름이 붙기 14년 전에 죽은 발명가 | ✅ | ✅ | ✅ | ⏳ | — |

⏳ = TTS 일일 쿼터 대기 (리셋 07:00 UTC). ◐ = 일부 확보.
